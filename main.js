...
const modalContent = {
  Project_1: {
    title: "MovieLand🎬",
    content:
      "A small website to search for your favourite movies! Bult using ReactJS and OMDB API",
    link: "https://manyakalra05-movieland.netlify.app/",
  },
  Project_2: {
    title: "Pixel Pet Paradise🐶",
    content:
      "Play with a cute pet of yours! All animations are made by me!",
    link: "https://manyakalra05-doggame.netlify.app/",
  },
  Project_3: {
    title: "NASA's Picture of the day",
    content:
      "See NASA's picture of the day, implemented through their official API",
    link: "https://manyakalra05-nasa-picoftheday.netlify.app/",
  },
  Chest: {
    title: "💁‍♀️ About Me",
    content:
      "Soooo, you found the chest! Well then, I'm Manya Kalra a 2nd Year Btech Student at IGDTUW. I'm an aspiring web developer. I have created my projects, which you should check out to know moe about me!",
  },
  Picnic: {
    title: "Something More🧺",
    content:
      "Other then tech, I love reading books, listening to music and i've trying my hand at some art too!",
  },
};
